    ...
    YAHOO.util.Event.addListener(window, "load", function() {
        ...
        if (extra_fields) {
            ...
            myColumnDefs = [
                ...
                {key:"3", sortable:true, resizeable:true, label:table_labels[3], formatter:"formatGene"},
                {key:"4", sortable:true, resizeable:true, label:table_labels[4]},
                {key:"5", sortable:true, resizeable:true, label:table_labels[5], formatter:"formatSequence"},
                {key:"6", sortable:true, resizeable:true, label:table_labels[6]},
                {key:"7", sortable:true, resizeable:true, label:table_labels[7],
