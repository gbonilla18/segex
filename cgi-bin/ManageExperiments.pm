...
'GROUP_CONCAT(CONCAT(study_brief.description, \' (\', study_brief.pubmed, \')\') SEPARATOR \', \')'
	...
	'source' => {
                ...
                view      => [qw/rsname/],
                names     => [qw/rsname/],
                meta      => { rsname => { label => 'Material Source' } },
            },
            ...
            'experiment' => {
                ...
                key       => [qw/eid/],
                view      => [
                    qw/eid sample1 sample2 ExperimentDescription AdditionalInformation AdditionalInformation2/
                ],
                resource => 'experiments',
                base     => [
                    qw/sample1 sample2 ExperimentDescription
                      AdditionalInformation AdditionalInformation2 pid stid file/
                ],
